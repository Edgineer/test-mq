<script>
    ...
    import Scotus from "$components/Scotus.svelte";
...
<div id="demo">
    ...
    <section id="demo-link">
        ...
        <p><a href="https://public.tableau.com/app/profile/izzy.valdivia/viz/SupremeCourtJusticeIdeologies/Comparison?publish=yes">Click here!</a></p>
    </section>
